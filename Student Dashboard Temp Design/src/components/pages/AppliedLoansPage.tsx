...
import { DollarSign, TrendingUp, Calendar, Lock, AlertCircle, CheckCircle, Clock } from 'lucide-react';
...
interface AppliedLoansPageProps {
...
export function AppliedLoansPage({ onNavigate, onStartCollateralDeposit }: AppliedLoansPageProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="mb-4 md:mb-6">
        <h1 className="mb-2">Applied Loans</h1>
