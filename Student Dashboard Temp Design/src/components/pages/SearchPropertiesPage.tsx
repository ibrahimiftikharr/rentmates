...
import { Search, SlidersHorizontal, Heart, MapPin, BedDouble, Bath, Maximize, X } from 'lucide-react';
...
import { PropertyDetailsPage } from '../property-details/PropertyDetailsPage';
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-12 h-12 md:h-14 border-2 focus:border-primary text-sm md:text-base"
                  />
                </div>
                <Button
                  variant="outline"
