...
interface RoommateMatchingSectionProps {
  onOpenVisitDialog?: (source: 'join-request') => void;
}

export function RoommateMatchingSection({ onOpenVisitDialog }: RoommateMatchingSectionProps) {
