...
import { ArrowLeft, Heart, Share2, MapPin, BedDouble, Bath, Ruler, Calendar, Wifi, Droplet, Zap, Home, Users, Shield, TrendingUp, User, Star, Check, X as XIcon, ChevronLeft, ChevronRight, Flag, DollarSign, Mail, Phone, Globe } from 'lucide-react';
...
export function PropertyDetailsPage({ property, onClose, onNavigate }: PropertyDetailsPageProps) {
  ...
  const amenities = [
    ...
    { icon: Droplet, name: 'Water Included' },
              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-shrink-0 mx-auto md:mx-0">
                  <Avatar className="w-40 h-40 border-4 border-primary/20 shadow-xl">
                    <AvatarImage src={selectedFlatmate.photo} />
                      ...
                      <CardContent className="p-6">
                        ...
                        <div className="flex flex-col items-center mb-5">
                          <Avatar className="w-32 h-32 border-4 border-white shadow-xl ring-4 ring-primary/10 mb-4">
                            <AvatarImage src={flatmate.photo} />
